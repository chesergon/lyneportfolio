document.addEventListener('DOMContentLoaded', function() {
    const botResponses = {
        contactPhoneResponse: "For any inquiries, feel free to contact me at 0716174954.",
        contactEmailResponse: "You can reach me via email at lynechesergon18@gmail.com.",
        contactLinkedInResponse: "Feel free to connect with me on LinkedIn:https://www.linkedin.com/in/lyne-chesergon-0a53272b5?utm", 
        contactTwitterResponse: "You can reach out to me on Twitter: https://x.com/chess_lyne?t=pcFQoJpiJ1GMh2SsADb3qw&s=09",
        contactGitHubResponse: "You can find more about me and my work on my GitHub profile: https://github.com/chesergon",
    ...
    function botReply(message) {
        const reply = document.createElement('div'); reply.classList.add('bot-message');
